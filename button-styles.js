...
window.BUTTON_STYLES = [
  ...
  /* ── ETHEREAL (NEW CATEGORY) ─────────────────────────────── */
  {
    id:"vortex", name:"Vortex", category:"ethereal", unlockAt:120, rarity:"rare",
    desc:"A spiraling gateway of pure energy. Reality swirls around it.",
    previewLabel:"Roll"
  },
  {
    id:"aurora", name:"Aurora", category:"ethereal", unlockAt:180, rarity:"legendary",
    desc:"Luminescent waves dance across frozen sky. Breath-taking beauty.",
    previewLabel:"✧ Roll ✧"
  },
  {
    id:"quantum", name:"Quantum", category:"ethereal", unlockAt:280, rarity:"mythic",
    desc:"The button exists in all states until observed. Schrodinger's Roll.",
    previewLabel:"◇ Roll ◇"
  },
  {
    id:"nebula", name:"Nebula", category:"ethereal", unlockAt:350, rarity:"mythic",
    desc:"Stardust and cosmic gas birth worlds at your fingertips.",
    previewLabel:"Roll"
  },
  {
    id:"infinity", name:"Infinity", category:"ethereal", unlockAt:600, rarity:"mythic",
    desc:"An endless loop of light consuming itself. Power incarnate.",
    previewLabel:"∞ Roll ∞"
  }
];
...
/* ── ETHEREAL CATEGORY ── */
.btn-primary.style-vortex{
  background:linear-gradient(45deg,#0a1828,#1a0a28,#0a0818);
  border:2px solid rgba(100,150,255,.5);color:#80c8ff;overflow:hidden;
  position:relative;font-family:'Cinzel',serif;font-size:10px;letter-spacing:.18em;
  box-shadow:0 0 20px rgba(100,150,255,.25),inset 0 0 20px rgba(100,150,255,.08);
}
.btn-primary.style-vortex::before{
  content:'';position:absolute;inset:0;border-radius:50%;
  background:conic-gradient(from 0deg,rgba(100,200,255,.2),rgba(150,100,255,.3),rgba(100,150,255,.2));
  animation:vortex-spin 4s linear infinite;pointer-events:none;
}
@keyframes vortex-spin{from{transform:rotate(0deg)}to{transform:rotate(360deg)}}
.btn-primary.style-vortex:hover{
  border-color:rgba(150,200,255,.8);color:#a0e0ff;
  box-shadow:0 0 40px rgba(150,200,255,.5),0 0 80px rgba(100,150,255,.25),inset 0 0 30px rgba(150,200,255,.15);
}

.btn-primary.style-aurora{
  background:linear-gradient(135deg,#1a3a4a,#0a2838,#1a1a3a);
  border:2px solid rgba(100,200,200,.4);color:#80ffcc;font-family:'Cormorant Garamond',serif;font-size:14px;letter-spacing:.15em;
  box-shadow:0 0 24px rgba(100,200,200,.2),inset 0 0 24px rgba(100,200,200,.06);
  position:relative;overflow:hidden;
}
.btn-primary.style-aurora::before{
  content:'';position:absolute;top:-50%;left:-50%;width:200%;height:200%;
  background:linear-gradient(45deg,transparent 30%,rgba(100,255,200,.1) 50%,transparent 70%);
  animation:aurora-flow 3s ease-in-out infinite;pointer-events:none;
}
@keyframes aurora-flow{from{transform:translate(-50%,-50%) rotate(0deg)}to{transform:translate(-50%,-50%) rotate(180deg)}}
.btn-primary.style-aurora:hover{
  border-color:rgba(150,255,200,.7);color:#c0ffdd;
  box-shadow:0 0 48px rgba(150,255,200,.6),0 0 96px rgba(100,200,200,.3),inset 0 0 32px rgba(150,255,200,.15);
}

.btn-primary.style-quantum{
  background:linear-gradient(90deg,#0a0a2a,#1a0a3a,#0a0a2a);
  border:2px dashed rgba(150,100,255,.5);color:#c080ff;font-family:'DM Mono',monospace;font-size:10px;letter-spacing:.2em;
  position:relative;overflow:hidden;box-shadow:0 0 16px rgba(150,100,255,.2),inset 0 0 16px rgba(150,100,255,.06);
}
.btn-primary.style-quantum::before{
  content:'';position:absolute;inset:0;background:linear-gradient(45deg,transparent 25%,rgba(180,120,255,.08) 25%,rgba(180,120,255,.08) 50%,transparent 50%,transparent 75%,rgba(180,120,255,.08) 75%);
  background-size:20px 20px;animation:quantum-shift 2s linear infinite;pointer-events:none;
}
@keyframes quantum-shift{from{background-position:0 0}to{background-position:20px 20px}}
.btn-primary.style-quantum:hover{
  border-color:rgba(200,150,255,.8);color:#e0b0ff;border-style:solid;
  box-shadow:0 0 36px rgba(200,150,255,.5),0 0 72px rgba(180,100,255,.25),inset 0 0 24px rgba(200,150,255,.12);
}

.btn-primary.style-nebula{
  background:radial-gradient(ellipse at 50% 50%,rgba(200,100,255,.15),rgba(50,0,150,.3));
  border:2px solid rgba(180,80,255,.45);color:#d080ff;font-family:'Cinzel',serif;font-size:11px;letter-spacing:.2em;
  position:relative;overflow:hidden;box-shadow:0 0 28px rgba(180,100,255,.3),0 0 56px rgba(150,50,200,.15),inset 0 0 20px rgba(180,100,255,.08);
}
.btn-primary.style-nebula::before{
  content:'';position:absolute;inset:0;
  background:radial-gradient(circle at 20% 30%,rgba(255,100,200,.1),transparent 40%),
              radial-gradient(circle at 80% 70%,rgba(100,150,255,.1),transparent 40%);
  animation:nebula-drift 8s ease-in-out infinite;pointer-events:none;
}
@keyframes nebula-drift{0%,100%{transform:translate(0,0)}50%{transform:translate(10px,-10px)}}
.btn-primary.style-nebula:hover{
  border-color:rgba(220,120,255,.8);color:#ff9fff;
  box-shadow:0 0 48px rgba(220,120,255,.6),0 0 96px rgba(180,80,255,.35),inset 0 0 32px rgba(220,120,255,.15);
}

.btn-primary.style-infinity{
  background:linear-gradient(135deg,#0e0a18,#1a0820,#0a0e1a);
  border:2px solid rgba(200,100,255,.6);color:#e8a8ff;font-family:'Cinzel',serif;font-size:12px;font-weight:600;letter-spacing:.22em;
  position:relative;overflow:hidden;
  box-shadow:0 0 32px rgba(200,100,255,.35),0 0 64px rgba(180,80,255,.18),inset 0 0 24px rgba(200,100,255,.1);
}
.btn-primary.style-infinity::before{
  content:'';position:absolute;left:-100%;top:-50%;width:200%;height:200%;
  background:linear-gradient(45deg,transparent 40%,rgba(255,100,255,.2) 50%,transparent 60%);
  animation:infinity-loop 3s linear infinite;pointer-events:none;
}
@keyframes infinity-loop{from{transform:translateX(0) rotate(0deg)}to{transform:translateX(100%) rotate(360deg)}}
.btn-primary.style-infinity::after{
  content:'';position:absolute;inset:0;border-radius:inherit;
  background:radial-gradient(ellipse at center,rgba(255,150,255,.1),transparent);
  animation:infinity-pulse 1.5s ease-in-out infinite;pointer-events:none;
}
@keyframes infinity-pulse{0%,100%{opacity:.4}50%{opacity:1}}
.btn-primary.style-infinity:hover{
  border-color:rgba(255,150,255,.9);color:#ffccff;
  box-shadow:0 0 64px rgba(255,150,255,.7),0 0 128px rgba(200,80,255,.4),inset 0 0 40px rgba(255,150,255,.2);
}
