...
@keyframes witchfire-burn{
  0%  {background-position:50% 100%;box-shadow:0 0 12px rgba(0,200,80,.3),0 0 28px rgba(0,140,60,.15),inset 0 0 20px rgba(0,180,60,.06)}
  33% {box-shadow:0 0 22px rgba(40,220,100,.5),0 0 44px rgba(0,160,70,.22),inset 0 0 30px rgba(20,200,70,.1)}
  66% {box-shadow:0 0 16px rgba(100,255,120,.4),0 0 36px rgba(20,180,80,.18),inset 0 0 24px rgba(40,220,90,.08)}
  100%{background-position:50% 0%;  box-shadow:0 0 12px rgba(0,200,80,.3),0 0 28px rgba(0,140,60,.15),inset 0 0 20px rgba(0,180,60,.06)}
}
@keyframes witchfire-text{
  0%,100%{text-shadow:0 0 8px rgba(80,255,120,.8),0 0 20px rgba(0,200,80,.5)}
  50%    {text-shadow:0 0 16px rgba(140,255,160,.9),0 0 36px rgba(60,220,100,.6),0 0 60px rgba(0,180,80,.3)}
}
@keyframes witchfire-drip{
  0%  {background-position:0% 0%;   filter:hue-rotate(0deg)  brightness(1)}
  40% {filter:hue-rotate(15deg) brightness(1.2)}
  70% {background-position:0% 100%;filter:hue-rotate(-10deg) brightness(.95)}
  100%{background-position:0% 0%;   filter:hue-rotate(0deg)  brightness(1)}
}
.btn-primary.style-witchfire{
  background:linear-gradient(180deg,#001a08,#002a10,#004020,#001a08);
  background-size:100% 300%;
  border:1px solid #00aa44;color:#40ff80;
  font-family:'Cinzel',serif;font-size:10px;letter-spacing:.2em;
  animation:witchfire-burn 3s ease-in-out infinite;
  position:relative;overflow:hidden;
}
.btn-primary.style-witchfire::before{
  ...
  background:repeating-linear-gradient(0deg,
    ...
    rgba(0,255,80,.03) 3px,rgba(0,255,80,.03) 4px
  );
  pointer-events:none;animation:witchfire-drip 4s linear infinite;
}
.btn-primary.style-witchfire::after{
  content:'⚗ Roll ⚗';position:absolute;inset:0;display:flex;align-items:center;justify-content:center;
  font-family:'Cinzel',serif;font-size:10px;letter-spacing:.2em;
  animation:witchfire-text 2s ease-in-out infinite;
  color:#40ff80;pointer-events:none;
}
.btn-primary.style-witchfire:hover{
  background:linear-gradient(180deg,#002a10,#004020,#006030,#002a10);
  background-size:100% 300%;color:#80ffaa;border-color:#40ff80;
}
...
/* ══════════════════════════════════════════════════════════
   ...
   ══════════════════════════════════════════════════════════ */
@keyframes rift-tear{
  0%  {background-position:0% 50%;clip-path:polygon(0 5%,100% 0%,100% 95%,0% 100%)}
  25% {clip-path:polygon(0 0%,100% 3%,100% 100%,0% 97%)}
  50% {background-position:100% 50%;clip-path:polygon(0 3%,100% 0%,100% 97%,0% 100%)}
  75% {clip-path:polygon(0 0%,100% 4%,100% 96%,0% 100%)}
  100%{background-position:0% 50%;clip-path:polygon(0 5%,100% 0%,100% 95%,0% 100%)}
}
@keyframes rift-aberration{
  0%,100%{text-shadow:-1px 0 1px rgba(255,0,100,.7),1px 0 1px rgba(0,220,255,.7),0 0 12px rgba(200,100,255,.6)}
  25%{text-shadow:-2px 0 2px rgba(255,0,80,.8),2px 0 1px rgba(0,255,200,.7),0 0 20px rgba(180,80,255,.7)}
  50%{text-shadow:2px 0 2px rgba(255,0,150,.8),-1px 0 1px rgba(0,200,255,.6),0 0 16px rgba(220,120,255,.8)}
  75%{text-shadow:-1px 0 1px rgba(200,0,255,.7),1px 0 2px rgba(0,255,220,.8),0 0 22px rgba(160,100,255,.6)}
}
@keyframes rift-scan{
...
@keyframes rift-glitch{
  0%,92%,100%{transform:skewX(0deg);filter:none}
  93%{transform:skewX(-4deg);filter:brightness(1.5) saturate(2)}
  94%{transform:skewX(3deg);filter:brightness(.8)}
  95%{transform:skewX(0deg);filter:brightness(1.3) hue-rotate(40deg)}
  96%{transform:skewX(-2deg);filter:none}
}
.btn-primary.style-rift{
  background:linear-gradient(135deg,#040010,#0a0020,#000818,#100008,#040010);
  background-size:300% 300%;
  border:1px solid rgba(180,80,255,.5);
  color:#d0a0ff;
  font-family:'Cinzel',serif;font-size:10px;letter-spacing:.22em;
  box-shadow:0 0 18px rgba(160,60,255,.22),inset 0 0 20px rgba(100,40,200,.08);
  animation:rift-tear 6s ease-in-out infinite,rift-glitch 8s ease-in-out infinite;
  position:relative;overflow:hidden;
}
.btn-primary.style-rift::before{
  content:'';position:absolute;
  left:0;right:0;height:1px;
  background:linear-gradient(90deg,transparent,rgba(200,100,255,.7),rgba(0,220,255,.5),rgba(200,100,255,.7),transparent);
  animation:rift-scan 2.5s linear infinite;
  pointer-events:none;
}
.btn-primary.style-rift::after{
  content:'⌁ Roll ⌁';position:absolute;inset:0;display:flex;align-items:center;justify-content:center;
  font-family:'Cinzel',serif;font-size:10px;letter-spacing:.22em;
  animation:rift-aberration 2.2s ease-in-out infinite;
  pointer-events:none;
}
.btn-primary.style-rift:hover{
  box-shadow:0 0 32px rgba(200,80,255,.45),0 0 60px rgba(0,200,255,.2),inset 0 0 30px rgba(140,60,220,.15);
  border-color:rgba(220,120,255,.8);
}
/* Rift roll text */
...
window.EXPERT_STYLES = new Set(['glitch','cipher','overdrive','fracture','singularity','rift','witchfire']);
